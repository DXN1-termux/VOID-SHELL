...
class VoidWizard:
    ...
    async def run(self):
        ...
        if ai_provider == "ollama":
            model = questionary.text("Ollama Model (default: qwen2.5-coder:0.5b):", default="qwen2.5-coder:0.5b").ask()
        ...
        console.print(f"[italic]Configuration saved to {self.config_path}[/italic]")
    ...
    def inject_alias(self):
        ...
        alias_line = f"\nalias v='python3 {os.getcwd()}/void_shell/main.py'\n"
